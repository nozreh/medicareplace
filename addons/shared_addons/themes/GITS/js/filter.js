	...
	pyro.filter = {
		...
		init: function(){
			...
			//$('a.cancel').button();
                        ...
                        $('input[type="checkbox"]', pyro.filter.$filter_form).on('click', function(){
